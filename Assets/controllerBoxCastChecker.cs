...
public class controllerBoxCastChecker : MonoBehaviour
{
    ...
    {
        return Physics.CheckBox(transform.position + boxCastCenterOffset, boxCastHalfExtents, boxCastOrientation);
    }
    ...
    private void OnDrawGizmos()
    {
        ...
        Gizmos.matrix = Matrix4x4.TRS(transform.position + boxCastCenterOffset, boxCastOrientation, Vector3.one);
